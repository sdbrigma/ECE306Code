...
*       Date:   September 2015
*       Description: Contains all ports definitions.
 ...
 */
  ...
  P3SEL1 &= ~R_REVERSE; // Set R_REVERSE to GPIO output for P3.5
  P3SEL0 &= ~R_REVERSE;
  P3OUT &= ~R_REVERSE;
  P3DIR |= R_REVERSE;
  ...
  P3SEL1 &= ~L_REVERSE; // Set L_REVERSE to GPIO output for P3.7
  P3SEL0 &= ~L_REVERSE;
  P3OUT &= ~L_REVERSE;
  P3DIR |= L_REVERSE;
}
