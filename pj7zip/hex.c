...
//****************************************************************************** 
  ...
  ADCtemp = ADC_Thumb;        // HEX value to read
  ...
  display_2[LINE_POS_L8] = tmpWork;    // Display character
  ...
  display_2[LINE_POS_L7] = tmpWork;    // Display character
  ...
  display_2[LINE_POS_L6] = tmpWork;    // Display character
...
//******************************************************************************
//
//  Description: This functions implements the ASCII display
//
//  Steffon Brigman
//  Sept 2015
//  Built with IAR Embedded Workbench Version: V4.10A/W32 (6.30.3)
//
// Globals: tempCount, tempDisplay[], tempCount
//
// Passed: hexTemp
//
